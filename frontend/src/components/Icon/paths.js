...
// Add anything from inside <svg> tag to dynamically load it as needed.
const config = {
  width:  "100%",
  height: "100%",
}
const icons = {
  cog: <svg version="1.1" width={config.width} height={config.height} viewBox="0 0 20 20">
    ...
    ,
  home:  <svg version="1.1" width={config.width} height={config.height} viewBox="0 0 20 20">
  ...
  ,
  floors: <svg version="1.1" width={config.width} height={config.height} viewBox="0 0 20 20">
...
,
  calendar: <svg version="1.1" width={config.width} height={config.height} viewBox="0 0 20 20">
  ...
  stats: <svg version="1.1" width={config.width} height={config.height} viewBox="0 0 20 20">
