  ...
  try {
    ...
    switch (action.name) {
      ...
      case "color":
        ...
        accessory.setColor(action.value, action.transitionTime || undefined);
        break;
      case "brightness":
        console.log(
      ...
      case "hue":
        ...
        accessory.setHue(action.value, action.transitionTime || undefined);
        break;
      case "saturation":
        console.log(
...
function getBatteryLife(tradfri) {
  ...
  Object.entries(tradfri.devices).forEach(device => {
